...
$var['admin_config']['text'] = BIRTHDAY_ADMIN_A13;
$var['admin_config']['link'] = "admin_config.php";

$var['admin_readme']['text'] = BIRTHDAY_ADMIN_A49;
$var['admin_readme']['link'] = "admin_readme.php";

$var['admin_vupdate']['text'] = BIRTHDAY_ADMIN_A48;
$var['admin_vupdate']['link'] = "admin_vupdate.php";

show_admin_menu(BIRTHDAY_ADMIN_A20, $action, $var);
