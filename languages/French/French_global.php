...
define("BIRTHDAY_LAN_0", "Les anniversaires du jour!!!");
define("BIRTHDAY_LAN_1", "Un anniversaire aujourd'hui!");
define("BIRTHDAY_LAN_2", "");
define("BIRTHDAY_LAN_3", "Anniversaires des membres: ");
define("BIRTHDAY_LAN_4", "Anniversaires");
define("BIRTHDAY_LAN_5", "Anniversaires suivants");
define("BIRTHDAY_LAN_6", "Pas d'anniversaire aujourd'hui");

define("BIRTHDAY_ADMIN_A1","Admin Anniversaires");
define("BIRTHDAY_ADMIN_A2","Nombre d'anniversaires futurs a afficher");
define("BIRTHDAY_ADMIN_A3","Mise a jour");
define("BIRTHDAY_ADMIN_A4","Format date jj/mm");
define("BIRTHDAY_ADMIN_A5","Réglages effectués");
define("BIRTHDAY_ADMIN_A6","Continuer");
...
define("BIRTHDAY_ADMIN_A26","Check this box to show the date of the birthday in dd/mm format. Default is mm/dd.");
